...
import 'package:banking_app/utlis/app_img.dart';
...
class AppWidgets {
  static Widget getLoadingView() => Center(
    child: SpinKitThreeBounce(color: AppColors.terneryColor, size: 35),
  );
  ...
  static Widget getNetworkImage(
    ...
    errorWidget: (context, url, error) =>
        Image.asset(AppImages.logo, height: height, width: width),
  );
  ...
  static AppBar titleBar(
    ...
    title: FittedBox(
      ...
      child: Text(title, style: Get.theme.textTheme.displaySmall),
    ),
    centerTitle: true,
